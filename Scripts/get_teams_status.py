...
DEFAULT_SETTINGS = {
    ...
    "teams_version": "Auto",
    "check_interval": 2,
    "status_entity": "sensor.teams_status",
    "status_friendly_name": "Microsoft Teams status",
    "activity_entity": "sensor.teams_activity",
    "activity_friendly_name": "Microsoft Teams activity",
